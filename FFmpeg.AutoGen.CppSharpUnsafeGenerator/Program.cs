...
internal class Program
{
    internal static void Main(string[] args)
    {
        ...
        var generationContext = new GenerationContext
        {
            ...
            FileHeader = CreateFileHeader(options.FFMoniker, options.FFVersion, options.FFUrl),
        };
    ...
    private static string CreateFileHeader(string moniker, string version, string url) => $"""
        /// <auto-generated>
        ///     File autogenerated using FFmpeg.AutoGen tool under LGPL-3.0 license, Ffmpeg bindings for {moniker} {version}. Treat as LGPL-2.1 licensed
        ///     
